...
export default function ProjectCard({ title, description, link }) {
  return (
    <a href={link} target="_blank" rel="noopener noreferrer" className="block p-4 border rounded-2xl hover:shadow-lg hover:scale-105 transition-transform duration-300 bg-foreground">
