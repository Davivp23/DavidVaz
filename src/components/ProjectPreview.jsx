      ...
      {project ? (
        ...
        >
          {isEmbedded && project.id === 'portafolio' ? (
            <pre className="w-full h-full flex items-center justify-center text-blue-400 dark:text-blue-500 transition-all duration-300 text-xs md:text-xs font-mono p-4 text-center">
              {asciiArt}
            </pre>
          ) : (
          <iframe
