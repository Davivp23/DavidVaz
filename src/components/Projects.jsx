...
const Projects = forwardRef(({ onHover }, ref) => {
  return (
    <section ref={ref} className="py-10">
      <h2 className="text-2xl font-semibold mb-4 text-blue-200">Proyectos</h2>
      <div className="flex flex-col gap-6">
        {projects.map((project) => (
          <Link
            ...
            <h3 className="text-xl font-bold text-blue-200" style={{ marginBottom: '1vh' }}>{project.title}</h3>
