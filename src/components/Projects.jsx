      ...
      <div className="flex flex-col gap-6">
        {projects.map((project) => (
          <Link
            ...
            <h3 className="text-xl font-bold text-blue-300 dark:text-blue-400 transition-all duration-300" style={{ marginBottom: '1vh' }}>{project.title}</h3>
            <p className="dark:text-gray-600 transition-all duration-300 text-gray-300" style={{ marginBottom: '0.5vh' }}>{project.description}</p>
            <p className="dark:text-gray-600 transition-all duration-300 text-gray-300" style={{ marginBottom: '0.5vh' }}>{project.technologies.join(', ')}</p>
          </Link>
        ))}
      </div>
    </section>
