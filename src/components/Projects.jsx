      ...
      <div className="flex flex-col gap-6">
        {projects.map((project) => (
          <Link
            ...
            <h3 className="text-xl font-bold text-blue-400" style="margin-bottom: 1vh;">{project.title}</h3>
            <p className="text-gray-300" style="margin-bottom: 0.5vh;">{project.description}</p>
            
            <p className="text-gray-300" style="margin-bottom: 0.5vh;">{project.technologies.join(', ')}</p>
          </Link>
        ))}
      </div>
    </section>
